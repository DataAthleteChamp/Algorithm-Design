...
"""
Inorder Traversal (w porządku rosnącym)
lewe podrzewo, wezeł, prawe podrzewo

Preorder Traversal
wezeł, lewe, prawe

Postorder Traversal
lewe podrzewo, prawe podrzewo, wezeł

drzewo binarne
wartości w jego lewym poddrzewie są mniejsze od wartości w samym węźle, 
a wartości w jego prawym poddrzewie są większe od wartości w węźle
